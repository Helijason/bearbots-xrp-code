...
public class Robot extends LoggedRobot {
  ...
  public void robotPeriodic() {
    ...
    Pose3d[] scoopPoses = robotContainer.getScoop().getMechanism().generate3dMechanisms();
    Pose3d[] allPoses = new Pose3d[1 + scoopPoses.length];
    allPoses[0] = robotContainer.getArm().getComponentPose();
    System.arraycopy(scoopPoses, 0, allPoses, 1, scoopPoses.length);
    Logger.recordOutput("FinalComponentPoses", allPoses);
