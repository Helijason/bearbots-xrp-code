...
public final class Constants {
  ...
  public static final Mode currentMode = Mode.SIM;              // Sim XRP
  //public static final Mode currentMode = Mode.REAL;             // Live XRP
  //public static final Mode currentMode = Mode.REPLAY;           // Replau XRP
