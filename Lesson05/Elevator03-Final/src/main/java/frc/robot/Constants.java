...
public final class Constants {
  ...
  public static final Mode currentMode = Mode.SIM;          // Simulation mode
  //public static final Mode simMode = Mode.REAL;           // Real mode
  //public static final Mode simMode = Mode.REPLAY;         // Replay mode
  ...
  /** WPILib command scheduler loop period in seconds. Matches TimedRobot default. */
  ...
  public static final class ArmHardware {
    ...
    public static final class ScoopHardware {
    private ScoopHardware() {}
 
    /** XRP servo device number. Device 5 maps to physical Servo 2 on the XRP. */
    public static final int kScoopServoDeviceNumber = 5;
  }
}